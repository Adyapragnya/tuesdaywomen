...
const authorsTableData = {
  columns: [
    { name: "Geofence_Name", align: "left" },
    { name: "Latitude", align: "left" },
    { name: "Logitude", align: "center" },
    { name: "Entry_Log", align: "center" },
    { name: "Exit_Log", align: "center" },
  ],

  rows: [
    {
      Geofence_Name: <Author image={team2} name="John Michael" email="john@creative-tim.com" />,
      Latituede: <Function job="Manager" org="Organization" />,
      status: (
